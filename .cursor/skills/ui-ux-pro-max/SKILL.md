...
name: ui-ux-pro-max
description: >-
  Design intelligence for professional UI/UX on web and mobile—67 styles, color palettes, typography pairings, UX guidelines, chart types, stack-specific rules, and design-system generation via the bundled Python search tool. Use when designing or building interfaces, landing pages, dashboards, fixing UI polish, or when the user mentions UI, UX, visual design, Tailwind, or a specific frontend stack.
---
...
**Cursor workspace:** Run every `python3 .cursor/skills/ui-ux-pro-max/scripts/search.py` command from the project root (the folder that contains `.cursor/`), or adjust the path accordingly.
